...
- Mixed item types: MCQ, TRUE/FALSE, NUMERICAL, WORD, ALGEBRAIC
- Personalized answer sheets with Full A4, 2-up, and 4-up print layouts
- Export selected or all answer-sheet print pages as PNG
...
- Numerical, WORD, and Algebraic cropped-answer teacher review
...
- NUMERICAL, WORD, and ALGEBRAIC responses are cropped and shown for teacher review.
- For 2-up or 4-up sheets, cut the mini sheets apart before scanning; Full A4 remains the most reliable scan mode.
